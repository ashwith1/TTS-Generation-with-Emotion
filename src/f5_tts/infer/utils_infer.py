...
def load_vocoder(vocoder_name="vocos", is_local=False, local_path="", device=device, hf_cache_dir=None):
    """Simplified vocoder loader with Hugging Face compatibility"""
    if vocoder_name == "vocos":
        if is_local:
            print(f"Loading Vocos from local path: {local_path}")
            vocoder = Vocos.from_pretrained(local_path)
        else:
            print("Downloading Vocos from Hugging Face Hub...")
            # Remove cache_dir from direct call
